...
public class Exemplo04 {
	...
	public static void main(String[] args) {
		Scanner sc = new Scanner(Exemplo04.class.getResourceAsStream("teste_arquivo.txt")).useLocale(Locale.US); // se não colocar locale ele capta o double por vírgula por ser do brasil (máquina)
